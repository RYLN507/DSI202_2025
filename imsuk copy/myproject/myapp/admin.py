...
class RestaurantAdmin(admin.ModelAdmin):
    list_display      = ('name', 'category', 'phone', 'opening_hours', 'price_range')
    list_filter       = ('category', 'opening_hours')
    ...
    fieldsets = (
        ...
        ('Extra Info', {
            'fields': (
                'opening_hours', 'price_range', 'rating_avg',
                'favorites',
            ),
        }),
    )
...
class DealAdmin(admin.ModelAdmin):
    ...
    search_fields = ('title',)
    filter_horizontal = ('menus',)  # ✅ ใช้ ManyToManyField
    fields = ('title', 'menus', 'image', 'original_price', 'discounted_price', 'start_time', 'end_time', 'is_active')
